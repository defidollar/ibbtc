...
describe.only("mainnet:fork - CurveBtcPeak", function() {
    before('setup contracts', async function() {
        ...
        await web3.eth.sendTransaction({ to: badgerDevMultisig, value: web3.utils.toWei('1'), from: alice })
        await sett.approveContractAccess(curveBtcPeak.address, { from: badgerDevMultisig })
    })
